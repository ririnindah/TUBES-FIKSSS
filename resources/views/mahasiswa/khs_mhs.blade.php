@extends('template') @section('content') <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header"> Kartu Hasil Studi</h1>
            <ol class="breadcrumb">
              <li class="active">
                <i class="fa fa-dashboard"></i> <a href="{{ route('dashboard_mhs') }}">Dashboard/</a> <i class="fa fa-tasks"></i> <a href="{{ route('generate') }}"></a>Kartu Hasil Studi
              </li>
            </ol>
          </div>
        </div>
              ...
              <div class="cardkhs ">
                <div class="right-container">
                    <form action="">
                        ...
                        <br>
                        <div class="form-group row">
                            <label for="status" class="col-sm-2 col-form-label">SKS kumulatif:</label>
                            <div class="col-sm-10">
